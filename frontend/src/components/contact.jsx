      ...
      <div className="flex flex-col p-2">
        <form onSubmit={handleSubmit}>
          <div className='flex flex-col'>
            <div className="flex flex-row w-100 sm:w-120 gap-4">
              <input
                type="text"
                name="name"
                placeholder="Name"
                className="input input-ghost w-50 sm:w-full input-lg border-0 border-b border-b-gray-700"
                value={formData.name}
            ...
            <input
              ...
              name="subject"
              placeholder="Subject"
              className="input input-ghost mt-10 w-100 sm:w-120 input-lg border-0 border-b border-b-gray-700"
              value={formData.subject}
              onChange={handleChange}
            />
            <textarea
              name="message"
              className="textarea textarea-ghost input-lg w-100 sm:w-120 border-0 border-b border-b-gray-700 mt-10"
              placeholder="Message"
